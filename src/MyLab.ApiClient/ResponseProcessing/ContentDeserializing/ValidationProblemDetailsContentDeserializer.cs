...
class ValidationProblemDetailsContentDeserializer : IContentDeserializer
{
    readonly JsonDeserializationTools _jsonSerTools;

    public ValidationProblemDetailsContentDeserializer(JsonDeserializationTools jsonSerTools)
    {
    ...
    {
        return returnType == typeof(ValidationProblemDetails);
    }
